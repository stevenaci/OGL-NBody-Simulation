...
namespace oglplus {
    ...
    public:
        ...
        friend ExampleTimePeriod operator+(
            ExampleTimePeriod a, ExampleTimePeriod b) {
        ...
        friend ExampleTimePeriod operator*(int a, ExampleTimePeriod b) {
            return ExampleTimePeriod(a * b._seconds);
        }

        /// Less than comparison
        friend bool operator<(ExampleTimePeriod a, ExampleTimePeriod b) {
    ...
    public:
        ...
        virtual double RenderPart(unsigned /*part_no*/, const ExampleClock& clock) {
            this->Render(clock);
            return 1.0;
        }
    };
    ...
    public:
        ...
        virtual ExampleTimePeriod DefaultTimeout() {
